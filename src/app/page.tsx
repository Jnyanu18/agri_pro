    ...
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      ...
      <main className="flex-1">
        ...
        <section className="relative py-20 md:py-32 lg:py-40 group">
          ...
          >
            <div className="h-56 bg-gradient-to-br from-primary to-accent blur-[106px] dark:from-primary/70"></div>
            <div className="h-32 bg-gradient-to-r from-secondary to-accent blur-[106px] dark:from-secondary/70"></div>
          </div>
